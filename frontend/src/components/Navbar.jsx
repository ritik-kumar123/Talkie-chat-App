...
const Navbar = () => {
  ...
  return <>
  <header className="fixed top-0 w-full z-40 bg-white/80 backdrop-blur-lg border
        ...
        <div className="flex items-center gap-3">
          {
            authUser && (
              <>
              <Link to={"/profile"} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md text-sm 
              ...
              font-medium text-red-700 hover:bg-red-100 transition">
